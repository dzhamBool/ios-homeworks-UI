...
struct PostModel {
    ...
    static func makeMockModel() -> [PostModel] {
        ...
        post.append(PostModel(author: "Батищева Анна", description: "КТО ПРОМОКНЕТ СИЛЬНЕЕ ВО ВРЕМЯ ДОЖДЯ? Провели исследование, в котором принимали участие три добровольца. Их одели в одинаковую одежду и перед тем, как выпустит их под дождь, узнали массу их сухой одежды. Первый в дождь шел пешком, второй - бежал трусцой, а третий бежал с максимальной скоростью. Преодолеть в «мокрую погоду» нужно было 1 км. 1-й двигался со скоростью 1м/с, 2-й со скоростью 2 м/с, а 3-й — 6 м/с. И вот все пришли к финишу, и ученые положили на весы мокрую одежду. Вот результаты. Меньше всего промок самый быстрый бегун, второе место занял тот, кто бежал трусцой, а больше всех вымок тот, кто шел пешком.", image: "rain", likes: 70, views: 190))
